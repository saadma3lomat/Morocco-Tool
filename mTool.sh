...
$kBK"|lolcat -F1; sleep 0.5
echo
echo "$MPF"; sleep 2
clear
figlet $MQ1|lolcat -F2
...
${BB}$iN19 ${Pu}$(hostname) ${BB}$MQ2 ${Pu}99${tran}
${Gr}$iN20
...
99)
	clear
	echo "$MQ8"; sleep 1
	${iI2}saadma3lomat/Morocco-Tool.git
	sleep 2
	echo "$MQ9"; sleep 2
;;
0|00)
...
fn_b() {
figlet $ce|lolcat; sleep 0.5
figlet $ce1|lolcat -F2; sleep 1.5
echo $MQ37; sleep 2
clear
}
